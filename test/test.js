 ...
 */
"use strict";
var notificore = require( '../lib/notificore.js' )( '<YOUR_ACCESS_KEY>' );
...
describe(
	...
	() => {
		it(
			...
			() => {
				return notificore.getBalance().then(
					r => {
...
describe(
	...
	() => {
		it(
			...
			() => {
				return notificore.getHLRPrices().then(
					r => {
						r.should.have.property( 'error' );
						r.error.should.be.equal( 0 );
		...
		it(
			...
			() => {
				return notificore.getSMSPrices().then(
					r => {
						r.should.have.property( 'error' );
						r.error.should.be.equal( 0 );
						r.should.have.property( 'prices' );
			...
			() => {
				return notificore.getViberPrices().then(
					r => {
						r.should.have.property( 'error' );
						r.error.should.be.equal( 0 );
						r.should.have.property( 'prices' );
